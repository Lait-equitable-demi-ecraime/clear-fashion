...
const fetchProducts = async (page = 1, size = 12) => {
  try {
    const response = await fetch(
      `https://clear-fashion-inky.vercel.app?page=${page}&size=${size}`
    );
...
const fetchBrands = async (page = 1, size = 12, brand='ALL') => {
    try {
        const response = await fetch(
            `https://clear-fashion-inky.vercel.app?page=${page}&size=${size}&brand=${brand}`
        );
        const body = await response.json();
...
const renderBrands = async () => {
    try {
        const response = await fetch(
            `https://clear-fashion-inky.vercel.app/brands`
        );
        const body = await response.json();
        if (body.success !== true) {
            console.error(body);
